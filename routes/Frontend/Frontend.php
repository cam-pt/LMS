...
// course payment
Route::post('/payment/bank','Payments\CheckPaymentController@store');
Route::post('/payments/bank','Payments\CheckPaymentController@send');
Route::group(['middleware' => 'auth'], function () {
    Route::get('/payments/{course}/form','Payments\CheckPaymentController@index');
});
Route::get('/inforuser/bank/{id}','User\InfouserpayController@store');
...
Route::get('/courses/intro/mail/{email}','Payments\CheckPaymentController@introCheckmail');
...
Route::group(['middleware' => 'auth'], function () {
    Route::group(['namespace' => 'User', 'as' => 'user.'], function () {
        ...
        Route::get('courses/success','CourseController@congrate')->name('courses.success');
        ...
        Route::get('courses/{id}/marketing', 'CourseController@getMarketing')->name('course.marketing')->middleware('affiliateCookie');;
        ...
        Route::post('/messages/api/{id}', 'MessageController@update')->name('messages.update');
    ...
    */
    Route::group(['namespace' => 'Author', 'as' => 'author.', 'middleware' => 'author'], function () {
        ...
        //assignment
        Route::get('/author/course/assignmentlist','CourseController@assignment')->name('course.assignmentlist');
