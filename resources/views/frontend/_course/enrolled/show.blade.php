                ...
                <div class="sidebar-course-intro">
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="info-instructor">
                                    ...
                                    <a href="#" data-backdrop="static" data-keyboard="false" class="sendMessage"
                                        data-toggle="modal" data-id="{{$course->author->id}}" data-target="#sendMessage">
                    ...
                    <div class="widget widget_equipment">
                        ...
                        <div class="equipment-body">
                            <social-sharing url="{{route('frontend.course.show', $course)}}" title="{{$course->title}}"
                    ...
                    <div class="widget widget_tags">
                        ...
                        <div class="tagCould">
                            ...
                            <a href="{{ route('frontend.course.tag.get', strToLower($tag->name)) }}" class="tag-btn">
                                {{ strToUpper($tag->name) }}</a>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="col-md-7">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                data-toggle="tab">{{trans('strings.frontend.description')}}</a></li>
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">{{trans('strings.frontend.content')}}</a></li>
                        <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">{{trans('strings.frontend.feedback')}}</a></li>
                    ...
                    <div class="tab-content">
                                ...
                                <div class="section-outline">
                                    <a data-toggle="collapsex" href="#section-{{$section->id}}">
                                        <h4 class="tit-section xsm">
                                            {{trans('strings.frontend.section')}} {{ $section->sortOrder }}: {{
                                            $section->title }}
                                    ...
                                    <ul class="section-list {!! $loop->first ? '':'collapsex' !!}" id="section-{{$section->id}}">
                                        ...
                                        <li>
                                            ...
                                            <div class="list-body">
                                                ...
                                                <p><a href="{{ route('frontend.lesson.show', [$section->course, $lesson] )  }}">{{
                                                        $lesson->title }}</a></p>
                                            ...
                                            <a href="{{ route('frontend.lesson.show', [$section->course, $lesson] )  }}"
                                                class="mc-btn-2"><i class="fa fa-play-circle"></i> {{
                                                $lesson->content->video_duration }} {{trans('strings.frontend.minutes')}}</a>
                                            @elseif($lesson->content && $lesson->content->content_type == 'article')
                                            <a href="{{ route('frontend.lesson.show', [$section->course, $lesson] )  }}"
                                                class="mc-btn-2"><i class="fa fa-file-text"></i>
                                                {{trans('strings.frontend.article')}}</a>
                                            @else
                                            <a href="{{ route('frontend.lesson.show', [$section->course, $lesson] )  }}"
                                                class="mc-btn-2"><i class="fa fa-question-circle"></i>
                                                {{trans('strings.frontend.quiz')}}</a>
                                            @endif
                                        </li>
                                        @endif
                                        @endforeach
                        ...
                        <div role="tabpanel" class="tab-pane" id="messages">
                            <reviews :course="{{$course->toJson()}}" :user_can_review="{{ Auth::check() && Auth::user()->canReviewCourse($course) ? 'true':'false' }}"
                                inline-template>
